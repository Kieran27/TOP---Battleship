...
//     }
//   }
//   const testShip1 = new Ship('carrier', 3, true)
//   const testShip2 = new Ship('destroyer', 3, false)
//   const testShip3 = new Ship('sub', 5, false)
//   const testShip4 = new Ship('sub', 11, false)
//
//   testPlaceShips(testShip1, 8, 3)
//   testPlaceShips(testShip2, 8, 3)
//   testPlaceShips(testShip3, 8, 3)
// })
//
// describe('Placing Invalid Ships', () => {
//   const newGameBoard = new Gameboard
//   const testShip = new Ship('sub', 5, false)
//   const testShip2 = new Ship('sub', 9, false)
//
//   test('Place Invalid Ship', () => {
//     expect(newGameBoard.placeShip(testShip2, 2, 1)).not.toBe('invalid Ship')
//     expect(newGameBoard.placeShip(testShip, 2, 2 )).toBe('Not Enough Room!')
//   })
// });
